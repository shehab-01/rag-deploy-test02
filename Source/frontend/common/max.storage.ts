...
const storage = {
   ...
   */
  local: {
    set: function (key: string, value: object | string) {
      try {
        ...
        console.error('max.storage.local set Error ->', e);
      }
    },
    get: function (key: string) {
      try {
        ...
        console.error('max.storage.local get Error ->', e);
      }
    },
    remove: function (key: string) {
      try {
        ...
        console.error('max.storage.local remove Error ->', e);
      }
    }
  },
   ...
   */
  session: {
    set: function (key: string, value: object) {
      try {
        ...
        console.error('max.storage.session set Error ->', e);
      }
    },
    get: function (key: string) {
      try {
        ...
        console.error('max.storage.session get Error ->', e);
      }
    },
    remove: function (key: string) {
      try {
        ...
        console.error('max.storage.session remove Error ->', e);
      }
    }
  }
};
